...
<div style="height:300px;  background-image: linear-gradient( #e6e6e6,black); ">
  <?php foreach ($s as $select) { ?>
      ...
      <div class="card-body">
        ...
        <div class="star-rating align-items-center ">
          <div class="stars-container">
            <div style="color:orange;" class="stars-inactive">
              <i class="	fas fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i><i class="fa fa-star">

              </i><i class="fa fa-star"></i>
            </div> <span class="score"> 4.5 </span> <span class="total-votes">
              (ratings 207)</span> | <span class="students-enrolled">students enrolled 21,906</span>
          </div>
        </div>
    ...
    <div class="card" style="width: 20rem; left:1200px">
      ...
      <div class="card-body" style="padding-left:15px; color:blue;border:  #e6e6e6 solid 3px; padding-bottom: 60px; font-style: oblique;">

        <h2 class="card-title"> <i class="far fa-user"></i> Instructor :</h2>
        <h3 class="card-subtitle mb-2 text-muted"><?php echo $row["instname"]; ?></h3>
